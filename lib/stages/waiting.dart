...
class Waiting extends StatefulWidget {
  ...
  Waiting({@required this.uid});

  @override
  _WaitingState createState() => _WaitingState();
}

class _WaitingState extends State<Waiting> with AutomaticKeepAliveClientMixin {
  @override
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.data.documents.length == 0) {
            ...
            return new Center(
                child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[new Text("No Waiting Queue")],
            ));
          } else {
            return new ListView.builder(
                itemCount: snapshot.data.documents.length,
                itemBuilder: (context, index) => buildWaitingList(
  ...
  buildWaitingList(BuildContext context, snapshot, index) {
    return new Padding(
...
class Bill2 extends StatefulWidget {
  final snapshot;

  Bill2({@required this.snapshot});

  @override
  _Bill2State createState() => _Bill2State();
}

class _Bill2State extends State<Bill2> {
